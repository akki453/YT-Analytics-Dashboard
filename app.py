...
if menu == 'Search Channels':
    ...
    with st.expander("ℹ️ How It Works", expanded=True):
        st.markdown("""
        This project allows you to analyze any YouTube video and uncover useful insights such as sentiment, engagement, and viewer behavior.

        **You can start in two ways:**
        - **Search by Keyword:** Enter a video title or keyword to fetch the most relevant video.
        - **Search by Video ID:** Directly enter a YouTube video ID for faster access.

        Once a video is selected, the app connects to the **YouTube Data API** to collect:
        - Video details (title, views, likes, comments, etc.)
        - Top comments and their **sentiment**
        - Comment activity and trends
        - **Topic modeling** using NLP

        The insights are visualized below in an interactive dashboard.
        """)
    ...
    with st.expander("ℹ️ How It Works", expanded=True):
        st.markdown("""
        This feature allows you to analyze any YouTube channel and gain deep insights into its overall performance, content strategy, and audience engagement.

        **You can begin in two ways:**
        - **Search by Keyword:** Enter a channel name or keyword to find the most relevant channel.
        - **Search by Channel ID:** Directly input a YouTube Channel ID for instant access.

        Once a channel is selected, the application fetches and analyzes key data using the **YouTube Data API**, such as:
        - Channel statistics (subscribers, total views, video count, etc.)
        - Recent video performance
        - Publishing frequency
        - Engagement trends over time
        - Top performing content
        - Topic distribution (via NLP)

        These insights are presented through interactive visualizations, helping you understand how a channel is performing and what content strategies are working best.
        """)
